...
## 6. Пошаговый план реализации (по готовности к выполнению)
...
* [ ] **Этап 2: Бэкенд-сервис `ingestion_service/` (Python)**
...
* [ ] **Этап 3: Мост к `agy cli` (`agy_bridge.py`)**
